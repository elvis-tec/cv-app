    ...
    <main className="px-3">
      <div className="row mb-4 align-items-center">
        ...
        <div className="col-md-8 col-sm-12 mt-2">
          ...
          <h2>About me</h2>
          <p className="lead">I'm a ICT engineer specializing in software development; I have five years of experience doing software. My technical skills are focused on custom software and e-commerce; Technologies like JavaScript, Liquid, HTML, CSS, Node.JS, PHP, etc.</p>
